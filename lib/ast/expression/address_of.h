 ...
 * home directory.
 */
#ifndef AST_EXPRESSION_ADDRESS_OF_H
#define AST_EXPRESSION_ADDRESS_OF_H
...
public:
    explicit AddressOf( const NonTerminals::Expression &parserOperand );
...
#endif // AST_EXPRESSION_ADDRESS_OF_H
